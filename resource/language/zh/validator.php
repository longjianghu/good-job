...
return [
    ...
    'retry'      => [
        'IsInt' => sprintf(ArrayHelper::getValue($erroMessage, 'IsInt'), ArrayHelper::getValue($labelName, 'retry')),
    ...
    'step'       => [
        'IsInt' => sprintf(ArrayHelper::getValue($erroMessage, 'IsInt'), ArrayHelper::getValue($labelName, 'step')),
    ...
    'retryTotal' => [
        'IsInt' => sprintf(ArrayHelper::getValue($erroMessage, 'IsInt'), ArrayHelper::getValue($labelName, 'retryTotal')),
        'Min'   => sprintf(ArrayHelper::getValue($erroMessage, 'Min'), ArrayHelper::getValue($labelName, 'retryTotal'), 0),
        'Max'   => sprintf(ArrayHelper::getValue($erroMessage, 'Max'), ArrayHelper::getValue($labelName, 'retryTotal'), 10),
    ],
    'linkUrl'    => [
